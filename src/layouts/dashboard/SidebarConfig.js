...
// import configurationFile from '@iconify/icons-eos-icons/configuration-file';
import gearFilled from '@iconify/icons-pepicons/gear-filled';
...
const sidebarConfig = [
  ...
  },
  {
    ...
    icon: getIcon(gearFilled)
  },
  {
    title: 'model',
    path: '/dashboard/model',
    icon: getIcon(machineLearningModel)
  },
  // {
  //   title: 'login',
  //   path: '/login',
